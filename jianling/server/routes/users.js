...
router.post('/creg',(req,res)=>{
  var obj=req.body;
  var sql="SELECT jid FROM jl_user WHERE uname=?"
...
router.post("/reg",(req,res)=>{
  var obj=req.body;
  var sql="INSERT INTO jl_user(uname,upwd,phone) values(?,md5(?),?)";
...
router.post('/login',(req,res)=>{
  var obj=req.body;
  // console.log(obj)
  var sql="SELECT jid FROM jl_user WHERE uname=? AND upwd=md5(?)"
